...
Public Class PreviousSchoolYearSemester
    ...
    Private Sub btnCreate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreate.Click
        ...
        Try
            MySQLConn.Open()
            comm = New MySqlCommand("CREATE TABLE `assignedsubj" & SchoolYearSemester.ComboBoxSchoolYear.Text + SchoolYearSemester.ComboBoxSemester.Text & "` LIKE assignedsubj;CREATE TABLE `subjectlist" & SchoolYearSemester.ComboBoxSchoolYear.Text + SchoolYearSemester.ComboBoxSemester.Text & "` LIKE subjectlist;CREATE TABLE `roomlist" & SchoolYearSemester.ComboBoxSchoolYear.Text + SchoolYearSemester.ComboBoxSemester.Text & "` LIKE roomlist;INSERT INTO `subjectlist" & SchoolYearSemester.ComboBoxSchoolYear.Text + SchoolYearSemester.ComboBoxSemester.Text & "` SELECT * FROM `subjectlist" & ComboBoxSchoolYear.Text + ComboBoxSemester.Text & "`;UPDATE `subjectlist" & SchoolYearSemester.ComboBoxSchoolYear.Text + ComboBoxSemester.Text & "` SET isAssigned='false';INSERT INTO existingschoolyearsemester VALUES(@schoolyear, @semester, @isActive);INSERT INTO `roomlist" & SchoolYearSemester.ComboBoxSchoolYear.Text + SchoolYearSemester.ComboBoxSemester.Text & "` SELECT room FROM `roomlist" & ComboBoxSchoolYear.Text + ComboBoxSemester.Text & "`;", MySQLConn)
